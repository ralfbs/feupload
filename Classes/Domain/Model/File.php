...
class Tx_Feupload_Domain_Model_File extends Tx_Extbase_DomainObject_AbstractEntity
{
	...
	/**
	 * @var string
	 * @validate Tx_Feupload_Domain_Validator_FileUploadValidator(property=file)
	 */
	protected $file;
	...
	/**
	 * @var Tx_Feupload_Domain_Model_FrontendUser
	 * @dontvalidate
	 */
	protected $feUser;
	...
	{
		if( $GLOBALS['TSFE']->fe_user->user && (int)$GLOBALS['TSFE']->fe_user->user['uid'] == (int)$this->feUser->uid ) return true;
		else return false;
	}
