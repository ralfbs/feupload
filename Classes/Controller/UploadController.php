...
class Tx_Feupload_Controller_UploadController extends Tx_Extbase_MVC_Controller_ActionController
{
	...
	protected function initializeAction()
	{
		...
		$this->config = $this->configurationManager->getConfiguration(Tx_Extbase_Configuration_ConfigurationManagerInterface::CONFIGURATION_TYPE_FRAMEWORK);
		...
		// Storage PID from user/group ts has precedence - may be deprecated in a newer version
	 ...
	 *
	 * @param					Tx_Feupload_Domain_Model_File		$file		File
	 * @dontvalidate	$file
	 * @return				void
	 */
	public function newAction(Tx_Feupload_Domain_Model_File $file = null)
	{
		...
		if( (bool)$this->userTS['allowAllGroups'] ) $groups = $this->frontendUserGroupRepository->findAll();
		else
		{
	...
	public function createAction(Tx_Feupload_Domain_Model_File $file)
	{
		...
		$this->flashMessageContainer->add(
			Tx_Extbase_Utility_Localization::translate('LLL:EXT:feupload/Resources/Private/Language/locallang.xml:flash.ok.file.uploaded.content'),
			Tx_Extbase_Utility_Localization::translate('LLL:EXT:feupload/Resources/Private/Language/locallang.xml:flash.ok.file.uploaded.title'),
